...
@Component({
  selector: 'app-pathigam',
  templateUrl: './pathigam.page.html',
  styleUrls: ['./pathigam.page.scss'],
  animations: [
    trigger('slideInOut', [
      transition(':enter', [
...
export class PathigamPage implements OnInit {
