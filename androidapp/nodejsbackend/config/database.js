...
const dbConfig = {
  ...
  database: process.env.DB_NAME || 'ldml_db',
  ...
  try {
    ...
    await connection.execute(`
      CREATE TABLE IF NOT EXISTS payments (
        ...
        INDEX idx_phonepe_transaction_id (phonepe_transaction_id),
        INDEX idx_phonepe_merchant_transaction_id (phonepe_merchant_transaction_id)
      )
    `);
