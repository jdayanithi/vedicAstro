...
var routes = [
  {
    path: "",
    loadChildren: () => import("./chunk-MKCVLFCH.js").then((m) => m.AUTH_ROUTES)
  },
  {
    path: "dashboard",
    loadChildren: () => import("./chunk-KGGYRKJI.js").then((m) => m.DASHBOARD_ROUTES),
    canActivate: [authGuard]
  },
  {
    path: "users",
    loadChildren: () => import("./chunk-RTPMGDBQ.js").then((m) => m.USERS_ROUTES),
    canActivate: [authGuard]
  },
  {
    path: "categories",
    loadChildren: () => import("./chunk-N77LYQJZ.js").then((m) => m.CATEGORY_ROUTES),
    canActivate: [authGuard]
  },
  {
    path: "courses",
    loadChildren: () => import("./chunk-S7YJU6R6.js").then((m) => m.COURSES_ROUTES),
    canActivate: [authGuard]
  },
  {
    path: "topics",
    loadChildren: () => import("./chunk-WYT2Z6OL.js").then((m) => m.TOPICS_ROUTES),
    canActivate: [authGuard]
  },
  {
    path: "lessons",
    loadChildren: () => import("./chunk-YBAAC6RT.js").then((m) => m.LESSONS_ROUTES),
    canActivate: [authGuard]
  },
  {
    path: "keynotes",
    loadChildren: () => import("./chunk-7ZEUIVZ6.js").then((m) => m.KEYNOTES_ROUTES),
    canActivate: [authGuard]
  },
  {
    path: "tags",
    loadChildren: () => import("./chunk-EDAJTHWJ.js").then((m) => m.TAGS_ROUTES),
    canActivate: [authGuard]
  },
  {
    path: "notifications",
    loadChildren: () => import("./chunk-JQLQIKHH.js").then((m) => m.NOTIFICATIONS_ROUTES),
    canActivate: [authGuard]
  },
  {
    path: "payments",
    loadChildren: () => import("./chunk-V35GJOXU.js").then((m) => m.PAYMENT_ROUTES),
    canActivate: [authGuard]
  },
  {
    path: "**",
